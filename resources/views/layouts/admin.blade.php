            ...
            <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                <ul class="space-y-1.5">
                    <x-sidebar.nav-link href="{{ route('dashboard') }}" active="{{ Request::routeIs('dashboard') }}">
                        <x-lucide-grid class="size-4" />
                        Dashboard
                    </x-sidebar.nav-link>
                    <x-sidebar.nav-link href="{{ route('movies.index') }}" active="{{ Request::routeIs('movies*') }}">

                        <x-lucide-clapperboard class="size-4" />
                        Movie
                    </x-sidebar.nav-link>
                    <x-sidebar.nav-link href="{{ route('genres.index') }}" active="{{ Request::routeIs('genres*') }}">
                        <x-lucide-dna class="size-4" />
                        Genre
                    </x-sidebar.nav-link>
                </ul>
            </nav>
